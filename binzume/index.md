...
　set_da()でMCP4922コマンドを送り出力電圧をセットしています．もしコードに興味があれば記事の最後に載せてあるGitHubのリポジトリを参照して下さい．
...
電流値を1mA程度に設定し，電極間に適当な抵抗をつないで電圧を測ります．たとえば，抵抗値を10kΩだとします．
...
回路図や実験に使ったソースコードは[GitHub上に](https://github.com/binzume/gvs)置いておきます．
